-- ============================================================
-- FIX CHECKOUT GAGAL ("Could not find the 'address' column")
-- ============================================================
-- Penyebab: migrasi sebelumnya BELUM dijalankan di project Supabase ini.
-- Solusi : copy-paste SELURUH file ini ke Supabase SQL Editor lalu Run.
--
-- Buka langsung:
-- https://supabase.com/dashboard/project/umgkqmfisducjekpzxgi/sql/new
-- ============================================================
...
do $$ begin alter publication supabase_realtime add table public.order_items;
exception when duplicate_object then null; end $$;
...
-- ============================================================
-- Selesai. Kembali ke website, refresh halaman, coba checkout lagi.
-- ============================================================
